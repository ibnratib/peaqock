# Generated by Django 3.2.7 on 2022-05-21 14:33
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nature_client', models.CharField(blank=True, max_length=100, null=True)),
                ('etat', models.CharField(blank=True, max_length=100, null=True)),
                ('raison_sociale', models.TextField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sens', models.IntegerField(blank=True, null=True)),
                ...
                ('compte_espece', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.comptesespece')),
            ],
        ),
    ]
